...
export declare class SyncEngine implements RemoteSyncer {
    ...
    private onlineState;
    constructor(localStore: LocalStore, remoteStore: RemoteStore, datastore: Datastore, sharedClientState: SharedClientState, currentUser: User, maxConcurrentLimboResolutions: number);
...
export declare class MultiTabSyncEngine extends SyncEngine implements SharedClientStateSyncer {
    ...
    constructor(localStore: MultiTabLocalStore, remoteStore: RemoteStore, datastore: Datastore, sharedClientState: SharedClientState, currentUser: User, maxConcurrentLimboResolutions: number);
    get isPrimaryClient(): boolean;
    enableNetwork(): Promise<void>;
    disableNetwork(): Promise<void>;
    /**
